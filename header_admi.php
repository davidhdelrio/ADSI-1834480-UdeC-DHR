...
<!-- Sidebar - Brand -->
     ...
     <li class="nav-item active">
       <a class="nav-link" href="contenidoindexadmi.php">
       <i class="fas fa-home" style="font-size: 21px;" ></i>
         <span style="font-size: 20px" >Inicio</span></a>
     </li>
     ...
     <!-- Nav Item - Pages Collapse Menu -->
        ...
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span  style="font-size: 18px;">Tabla</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           
            <a class="collapse-item" href="tablacompleta.php">Encuestas</a>
            <a class="collapse-item" href="#">Sesiones de Usuarios</a>
          </div>
        </div>
      </li>
     ...
     <li class="nav-item active">
       <a class="nav-link collapsed" href="graficas.php" >
        <i class="fas fa-chart-bar" style="font-size: 21px;"></i>
         <span style="font-size: 18px;">Estadistica</span>
       </a>
      
     </li>
       <li class="nav-item active">
       <a class="nav-link collapsed" href="graficas2.php" >
        <i class="fas fa-chart-bar" style="font-size: 21px;"></i>
         <span style="font-size: 18px;">Estadistica 2</span>
       </a>
