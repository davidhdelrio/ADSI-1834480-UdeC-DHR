        ...
        <img style="width: 350px; height: 350px; margin-left: 30px; margin-top: 20px;" src="img/login.png" alt="">
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="post" action="validateregister.php" >
              ...
              <input type="text" class="form-control form-control-user" id="identificacion" name="identificacion" placeholder="Identificacion" >
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="apellido" name="apellido"  placeholder="Apellidos">
                  </div>
                </div>
